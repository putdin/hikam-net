...
class Index extends CI_Controller
{
	...
	public function update_spp($id_spp)
	{
		...
		if (!$valid->run()) {
			...
			$this->session->set_flashdata('message', 'Update Paket <b>' . $spp->tahun . '</b> telah Berhasil');
			redirect('admin/index/spp');
		}
	}
	...
	public function delete_spp($id_spp)
	{
		...
		$this->session->set_flashdata('message', 'Data Paket <b>' . $spp->tahun . '</b> telah dihapus');
		redirect('admin/index/spp');
	}
}